...
I would love to discuss distributed systems and ML platforms!
...
University of Pennsylvania, CIS graduate level course focusing on making a basic operating system from scratch in C.

[Video coming soon]

Background: built a kernel and scheduler that interacts with a file system

**Key Responsibilities**:

* Built a full-fledged kernel and scheduler
* PennFAT
